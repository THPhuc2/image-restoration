...
if __name__ == "__main__":
    ...
    parser.add_argument("--test_path", type=str, default="/coding/SEM_8/MLN_111/photo_restoration/input_img_folder")
    parser.add_argument("--output_dir", type=str, default="/coding/SEM_8/MLN_111/photo_restoration/output_img_folder")
