...
class Predictor(cog.Predictor):
    def setup(self):
        ...
        parser.add_argument(
            "--input_folder", type=str, default="/coding/SEM_8/MLN_111/photo_restoration/input_img_folder", help="Test images"
        )
        parser.add_argument(
            "--output_folder",
            type=str,
            default="/coding/SEM_8/MLN_111/photo_restoration/output_img_folder",
