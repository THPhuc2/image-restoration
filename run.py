...
if __name__ == "__main__":
    ...
    parser.add_argument("--input_folder", type=str, default="input_img_folder", help="Test images")
    parser.add_argument("--output_folder",type=str,default="output_img_folder",help="Restored images, please use the absolute path")
    ...
    parser.add_argument("--with_scratch", default=True, action="store_true")
    ...
    exists_final = os.path.join(main_environment, 'output_img_folder','final_output')

    if os.path.exists(exists_final):
        shutil.rmtree(exists_final, ignore_errors=True)
